# -*- coding: utf-8 -*-
"""
Created on Wed Nov 23 19:46:07 2016
...
class planetary_motion:
    ...
    def period_calculate(self):
        ...
        vmax=np.sqrt(self.GM)*np.sqrt((1+self.e)/(self.a*(1-self.e))*(1+self.Mp/self.Ms))
        T=np.pi*self.a*b*2/(vmax*rmin)
        print(T)
a=planetary_motion(1998000,7,0.1,3)
x1,y1=a.motion_calculate()
a.period_calculate()
pl.scatter([0],[0],s=100,color='yellow')
pl.plot(x1,y1)
pl.xlabel('x(AU)')
pl.ylabel('y(AU)')

b=planetary_motion(1998000,60,0.05,13)
...
c=planetary_motion(1998000,200,0.5,25)
